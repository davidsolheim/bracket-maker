...
export function LosersBracket({
  ...
  return (
    <div className="rounded-lg border-2 border-orange-200 bg-orange-50/50 p-6 dark:border-orange-800 dark:bg-orange-950/20">
      <h2 className="mb-6 text-2xl font-bold text-orange-700 dark:text-orange-300">
        Losers Bracket
      </h2>
